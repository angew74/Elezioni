...
--
-- Table structure for table `ricalcolo_voti_sindaco`
--

DROP TABLE IF EXISTS `ricalcolo_voti_sindaco`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `ricalcolo_voti_sindaco` (
  ...
  CONSTRAINT `fk_ricalcolo_voti_sindaco_sindaco` FOREIGN KEY (`sindacoid`) REFERENCES `sindaci` (`id`),
  CONSTRAINT `fk_ricalcolo_voti_sindaco_tipo_elezione` FOREIGN KEY (`tipoelezioneid`) REFERENCES `tipoelezione` (`id`),
  CONSTRAINT `fk_ricalcolo_voti_sindaco_tipo_ricalcolo` FOREIGN KEY (`tiporicalcoloid`) REFERENCES `tipo_ricalcolo` (`id`)
