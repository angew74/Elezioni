...
--
-- Table structure for table `ricalcolo_voti_lista`
--

DROP TABLE IF EXISTS `ricalcolo_voti_lista`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `ricalcolo_voti_lista` (
...
-- Dump completed on 2019-07-07 11:51:27
