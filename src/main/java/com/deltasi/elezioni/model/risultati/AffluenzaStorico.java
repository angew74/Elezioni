...
@Entity
@Table(name = "affluenze_storico")
public class AffluenzaStorico {
    ...
    public LocalDateTime getDataoperazioneold() {
        return dataoperazioneold;
    }

    public void setDataoperazioneold(LocalDateTime dataoperazioneold) {
        this.dataoperazioneold = dataoperazioneold;
    }

    public String getUtenteoperazioneold() {
        return utenteoperazioneold;
    }
